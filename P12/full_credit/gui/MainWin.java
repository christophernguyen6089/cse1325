...
public class MainWin extends JFrame{
    ...
    public MainWin(String mainWindowTitle){
        ...
        mManager = new JMenuItem("Manager");
        ...
        mManager.addActionListener(event -> onCreateManagerClick());
        ...
        bManager = new JButton(new ImageIcon("manager.png"));
            bManager.setActionCommand("Create new Manager");
            bManager.setToolTipText("Create a new Manager");
            toolbar.add(bManager);
            bManager.addActionListener(event->onCreateManagerClick());
    ...
    protected void onCreateOrderClick(){
        ...
        JLabel productLabel = new JLabel("<HTML><br/>Order</HTML>");
        add(productLabel,constraints);
        
        JTextField productName = new JTextField(20);
            productName.addActionListener(
                event -> JOptionPane.showMessageDialog(this, productName.getText()));
    ...
    protected void onCreateServerClick(){
        ...
        protected void onCreateManagerClick(){
            setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            setSize(480,110);
        
            JLabel nameLabel = new JLabel("<HTML><br/>Name of new manager<HTML>");
            add(nameLabel,constraints);
            ...
            JLabel phoneLabel = new JLabel("<HTML><br/>Phone number of new manager<HTML>");
            add(phoneLabel,constraints);
            ...
            JLabel ssnLabel = new JLabel("<HTML><br/>SSN of new manager<HTML>");
            add(ssnLabel,constraints);
